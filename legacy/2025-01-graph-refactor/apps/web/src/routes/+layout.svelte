<script lang="ts">
  ...
  function updateBreadcrumbs(pathname: string) {
    ...
    const breadcrumbs = [{ label: 'Hjem', href: '/', icon: '🏠' }];
  ...
  <script>
    ...
    try {
      ...
      if (saved) {
        ...
        const theme =
          state.temporal && new Date(state.temporal.expires) > new Date()
...
<div class="app" data-theme={$theme}>
  ...
  <div class="app-body">
    ...
    <div class="content-area" data-nav-collapsed={$navigationState.sideNavCollapsed}>
      <ContentHeader />
