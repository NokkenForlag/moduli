...
>;
export declare const CollectionMemberSchema: z.ZodUnion<
  [
    z.ZodString,
    z.ZodObject<
      {
...
>;
export declare const isConceptFrontmatter: (
  obj: unknown,
) => obj is ConceptFrontmatter;
export declare const isParsedConcept: (obj: unknown) => obj is ParsedConcept;
export declare const isCollectionMember: (
  obj: unknown,
) => obj is CollectionMember;
